...
- (instancetype)setContent:(UIView *)content {
    return [self setContent:content animated:self.willAnimateContentChange];
}

- (instancetype)setContent:(UIView *)content animated:(BOOL)animated {
    return [self setContent:content animated:animated contentType:GddHudContentTypeCustom];
}

- (instancetype)setContent:(UIView *)content animated:(BOOL)animated contentType:(GddHudContentType)contentType {
...
- (instancetype)setLoading
{
    UIActivityIndicatorView* aiv = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleWhiteLarge];
    aiv.color = self.activityIndicatorColor;
    [aiv startAnimating];
    return [self setContent:aiv animated:self.willAnimateContentChange contentType:GddHudContentTypeLoading];
}

- (instancetype)setDismissesOnCoverTap {
...
+ (instancetype) loader {
    return [(GddHud *)[[self new] setLoading] show];
}

+ (instancetype)show:(NSString *)text {
    return [[[(GddHud *)[self new] setText: text] setDismissesOnCoverTap] show];
}
